...
$(function() {
    ...
    //     $.each(lang, function(language, pourceent) {

    //         var delay = 600;

    //         setTimeout(function() {
    //             $('#' + language + '-pourcent').html(pourceent);
...
$('#subscribe').ajaxChimp({
    language: 'eng',
    url: 'https://www.google.com/subscribe/post?u=88b2522a6203591b597a7e4e6&amp&id=1291144d60'
});
